#ifndef _BOARD_INCLUDE_BOARD_LCD_ST7796U_H_
#define _BOARD_INCLUDE_BOARD_LCD_ST7796U_H_
 ...
 */
typedef struct {
    const st7796u_lcd_init_cmd_t *init_cmds;     /*!< Pointer to initialization commands array. Set to NULL if using default commands.
...
#endif /* _BOARD_INCLUDE_BOARD_LCD_ST7796U_H_ */
